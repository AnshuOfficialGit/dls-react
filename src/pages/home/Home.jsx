            ...
            <div className="row">
              <div className="col-lg-5 valign md-mb50">
                <div className="mb-50">
                  ...
                  <p>
                    Your Trusted Technology Partner At DLSTech Nexus, we
                    transform your ideas into powerful digital solutions. We
                    specialize in end-to-end software development, from design
                    to deployment, ensuring seamless experiences. Whether it's
                    Figma design, development, testing, or cloud services, we
                    cover all aspects to elevate your business. Let's build the
                    future together!
                  </p>
                    ...
                    >
                      <div className="item">
                        <p>
                          ...
                          euismod nibh volutpat velit class aptent taciti
                          sociosqu ad litora.
                        </p>
                        <div className="info">
                          <div className="img">
